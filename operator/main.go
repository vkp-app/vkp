...
func main() {
	...
	flag.BoolVar(&clusterOpts.AllowHA, "cluster-allow-ha", true, "determines whether HA control-planes should be allowed given the dependency on the Postgres Operator.")
